...
import fr.chesscards.repository.VarianteRepository;
import fr.chesscards.service.VarianteService;
...
/**
 * REST controller for managing {@link fr.chesscards.domain.Variante}.
 */
@RestController
@RequestMapping("/api")
