...
import fr.flashcards.repository.OuvertureRepository;
import fr.flashcards.service.OuvertureService;
...
/**
 * REST controller for managing {@link fr.flashcards.domain.Ouverture}.
 */
@RestController
@RequestMapping("/api")
public class OuvertureResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/ouvertures/{id}", consumes = { "application/json", "application/merge-patch+json" })
